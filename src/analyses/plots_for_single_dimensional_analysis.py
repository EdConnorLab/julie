...
from social_data_processor import extract_specific_social_behavior, generate_edge_list_from_pairwise_interactions
from social_data_reader import SocialDataReader

social_data = SocialDataReader().social_data
affiliative_behaviors = list(behaviors.AffiliativeBehaviors)
aff = extract_specific_social_behavior(social_data, affiliative_behaviors)
edgelist_affiliative = generate_edge_list_from_pairwise_interactions(aff)
